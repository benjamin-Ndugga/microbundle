...
public class HZClient {
    ...
    public Integer getOptionId(String msisdn) throws NullPointerException, IllegalStateException, NamingException {
        ...
        try {
            ...
            //get the option id
            IMap<String, Integer> map = client.getMap("com.airtel.ug.micro.optionid");
    ...
    public void saveOptionId(String msisdn, String optionId) throws ParseException, NamingException, NullPointerException, IllegalStateException {
        HazelcastInstance client = null;
        try {
            ...
            map.put(msisdn, Integer.parseInt(optionId));
    ...
    public Integer getBillingOption(String msisdn) throws IllegalStateException, NamingException {
        ...
        try {
            ...
            IMap<String, Integer> map = client.getMap("com.airtel.ug.micro.billingoption");
    ...
    public void clearSessionData(String msisdn) {
        ...
        try {
            ...
            //get the option id
            IMap<String, Integer> mapOptionId = client.getMap("com.airtel.ug.micro.optionid");
            mapOptionId.remove(msisdn);

            IMap<String, Integer> mapBillingOption = client.getMap("com.airtel.ug.micro.billingoption");
